...
namespace JuBai.Migrations
{
    ...
    [Migration("20240919124137_AddNameToUser")]
            ...
            modelBuilder.Entity("JuBai.Models.Like", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 9, 19, 14, 41, 36, 553, DateTimeKind.Local).AddTicks(411),
                            PostId = 1,
                            UserId = 1
                        });
                });
            ...
            modelBuilder.Entity("JuBai.Models.Media", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 9, 19, 14, 41, 36, 553, DateTimeKind.Local).AddTicks(394),
                            PostId = 1,
                            Type = 0,
            ...
            modelBuilder.Entity("JuBai.Models.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 9, 19, 14, 41, 36, 553, DateTimeKind.Local).AddTicks(328),
                            IsPublished = true,
                            Likes = 0,
                            Title = "First Post"
                        });
